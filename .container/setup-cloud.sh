...
export DOCS_PORT="${DOCS_PORT:-6020}"
...
export CLOUD_DOCS_ENABLED="${CLOUD_DOCS_ENABLED:-true}"
export CLOUD_PRODUCT_APPS="${CLOUD_PRODUCT_APPS:-auditor:6030,ecommerce:6031,b2b-connect:6032,sports:6033,learning:6034,welfare:6035,crm:6036,sites:6037,blog:6038,zetro:6039,textile-lab:6040,garment:6041,upvc:6042,b2b-connect-admin:6043,cxsync:6044}"
export CLOUD_CXSYNC_CLOUD_ENABLED="${CLOUD_CXSYNC_CLOUD_ENABLED:-false}"
export CXSYNC_CLOUD_PORT="${CXSYNC_CLOUD_PORT:-6077}"
export CXSYNC_CLOUD_HOST="${CXSYNC_CLOUD_HOST:-0.0.0.0}"
export CXSYNC_CLOUD_LOG_LEVEL="${CXSYNC_CLOUD_LOG_LEVEL:-info}"
export CXSYNC_SERVICE_KEY="${CXSYNC_SERVICE_KEY:-}"
...
echo "Cloud docs enabled: $CLOUD_DOCS_ENABLED"
echo "Cloud product apps: $CLOUD_PRODUCT_APPS"
echo "CXSync Cloud enabled: $CLOUD_CXSYNC_CLOUD_ENABLED"
echo "CXSync Cloud port: $CXSYNC_CLOUD_PORT"
