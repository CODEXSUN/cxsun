    ...
    menuGroups: [
      ...
      { title: "Master", icon: PackageSearch, items: [item("billing", "contact", "Contact", UsersRound), item("billing", "product", "Product", PackageSearch), item("billing", "order", "Order", ShoppingBag)] },
      {
        ...
        items: [
          ...
          { ...item("billing", "contacts", "Contacts", UsersRound), items: [item("billing", "customer", "Customers", UsersRound), item("billing", "supplier", "Suppliers", UsersRound), item("billing", "address-book", "Address Book", MapPin)] },
          { ...item("billing", "product-common", "Product", PackageSearch), items: [item("billing", "category", "Categories", Tags), item("billing", "brand", "Brands", Tags), item("billing", "unit", "Units", Boxes)] },
          { ...item("billing", "tax-common", "Tax", CircleDollarSign), items: [item("billing", "tax", "Tax", CircleDollarSign), item("billing", "gst-slab", "GST Slab", CircleDollarSign), item("billing", "duties", "Duties", CircleDollarSign)] },
        ],
      },
