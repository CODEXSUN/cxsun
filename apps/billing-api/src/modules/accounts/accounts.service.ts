...
import { NotFoundException } from '@cxsun/platform/core/exceptions/http.exception.js'
...
import { commandId, type PostVoucherCommand, type RecalculatePostingCommand, type RecalculateReportTablesCommand, type ReverseDocumentCommand } from '@cxsun/platform/modules/entries/shared/entry-command.dto.js'
import { EntryPostingControlService, type PeriodLockInput } from '@cxsun/platform/modules/entries/shared/entry-posting-control.service.js'
