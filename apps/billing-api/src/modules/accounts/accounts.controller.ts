import { Body, Headers, Param, Query } from '@cxsun/platform/core/decorators/http-params.js'
...
import type { PostVoucherCommand, RecalculatePostingCommand, RecalculateReportTablesCommand, ReverseDocumentCommand } from '@cxsun/platform/modules/entries/shared/entry-command.dto.js'
import type { PeriodLockInput } from '@cxsun/platform/modules/entries/shared/entry-posting-control.service.js'
