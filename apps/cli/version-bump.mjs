...
const VERSION_FILES = [
  ...
  'apps/ecommerce-api/package.json',
  'apps/crm-api/package.json',
  'apps/tally-api/package.json',
  'apps/frappe-api/package.json',
  'apps/task-manager-api/package.json',
  'apps/auditor-api/package.json',
  'apps/blog-api/package.json',
  'apps/agent-os-api/package.json',
  'apps/sites/package.json',
  'apps/sites-api/package.json',
  'apps/sports/package.json',
  'apps/textile-lab/package.json',
  'apps/upvc/package.json',
  'apps/welfare/package.json',
  'apps/zetro/package.json',
