...
import { FrappeModule } from '@cxsun/platform/modules/frappe/index.js'

@Module({
  imports: [HealthModule, AuthModule, TenantModule, TenantDomainModule, FrappeModule],
  guards: [AuthGuard, AuthAnyGuard],
})
export class FrappeApiModule {}
