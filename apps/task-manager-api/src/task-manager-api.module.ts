...
import { TaskManagerModule } from '@cxsun/platform/modules/task-manager/index.js'

@Module({
  imports: [HealthModule, AuthModule, TenantModule, TenantDomainModule, MediaModule, TaskManagerModule],
  guards: [AuthGuard, AuthAnyGuard],
})
export class TaskManagerApiModule {}
