...
import { TallyModule } from '@cxsun/platform/modules/tally/index.js'

@Module({
  imports: [HealthModule, AuthModule, TenantModule, TenantDomainModule, TallyModule],
  guards: [AuthGuard, AuthAnyGuard],
})
export class TallyApiModule {}
