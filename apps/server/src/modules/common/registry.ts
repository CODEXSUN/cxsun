import { countriesCommonDefinition } from './location/countries/domain/value-objects/countries.definition.js'
import { statesCommonDefinition } from './location/states/domain/value-objects/states.definition.js'
import { districtsCommonDefinition } from './location/districts/domain/value-objects/districts.definition.js'
import { citiesCommonDefinition } from './location/cities/domain/value-objects/cities.definition.js'
import { pincodesCommonDefinition } from './location/pincodes/domain/value-objects/pincodes.definition.js'
import { contactGroupsCommonDefinition } from './contacts/contact-groups/domain/value-objects/contact-groups.definition.js'
import { contactTypesCommonDefinition } from './contacts/contact-types/domain/value-objects/contact-types.definition.js'
import { addressTypesCommonDefinition } from './contacts/address-types/domain/value-objects/address-types.definition.js'
import { bankNamesCommonDefinition } from './contacts/bank-names/domain/value-objects/bank-names.definition.js'
import { productGroupsCommonDefinition } from './product/product-groups/domain/value-objects/product-groups.definition.js'
import { productCategoriesCommonDefinition } from './product/product-categories/domain/value-objects/product-categories.definition.js'
import { productTypesCommonDefinition } from './product/product-types/domain/value-objects/product-types.definition.js'
import { unitsCommonDefinition } from './product/units/domain/value-objects/units.definition.js'
import { hsnCodesCommonDefinition } from './product/hsn-codes/domain/value-objects/hsn-codes.definition.js'
import { taxesCommonDefinition } from './product/taxes/domain/value-objects/taxes.definition.js'
import { brandsCommonDefinition } from './product/brands/domain/value-objects/brands.definition.js'
import { coloursCommonDefinition } from './product/colours/domain/value-objects/colours.definition.js'
import { sizesCommonDefinition } from './product/sizes/domain/value-objects/sizes.definition.js'
import { currenciesCommonDefinition } from './others/currencies/domain/value-objects/currencies.definition.js'
import { orderTypesCommonDefinition } from './orders/order-types/domain/value-objects/order-types.definition.js'
import { stylesCommonDefinition } from './product/styles/domain/value-objects/styles.definition.js'
import { transportsCommonDefinition } from './orders/transports/domain/value-objects/transports.definition.js'
import { warehousesCommonDefinition } from './orders/warehouses/domain/value-objects/warehouses.definition.js'
import { destinationsCommonDefinition } from './orders/destinations/domain/value-objects/destinations.definition.js'
import { paymentTermsCommonDefinition } from './others/payment-terms/domain/value-objects/payment-terms.definition.js'
import { accountingYearCommonDefinition } from './others/accounting-year/domain/value-objects/accounting-year.definition.js'
import { monthsCommonDefinition } from './others/months/domain/value-objects/months.definition.js'
import { stockRejectionTypesCommonDefinition } from './orders/stock-rejection-types/domain/value-objects/stock-rejection-types.definition.js'
