...
@Controller('api/v1/common/currencies')
export class CurrenciesCommonV1Controller {
  constructor(@Inject(CurrenciesCommonService) private readonly records: CurrenciesCommonService) {}
