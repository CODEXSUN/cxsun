...
export function migrateCurrenciesCommonTable(database: Kysely<TenantDatabaseSchema>) {
  return migrateMasterRecordDefinition(database, currenciesCommonDefinition)
}
