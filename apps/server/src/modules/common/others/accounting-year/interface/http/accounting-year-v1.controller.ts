...
@Controller('api/v1/common/accountingYear')
export class AccountingYearCommonV1Controller {
  constructor(@Inject(AccountingYearCommonService) private readonly records: AccountingYearCommonService) {}
