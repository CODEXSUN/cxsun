...
@Controller('api/v1/common/cities')
export class CitiesCommonV1Controller {
  constructor(@Inject(CitiesCommonService) private readonly records: CitiesCommonService) {}
