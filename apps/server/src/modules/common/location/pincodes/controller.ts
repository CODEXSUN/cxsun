...
@Controller('api/v1/common/pincodes')
export class PincodesCommonV1Controller {
  constructor(@Inject(PincodesCommonService) private readonly records: PincodesCommonService) {}
