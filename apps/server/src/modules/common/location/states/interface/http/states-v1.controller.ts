...
@Controller('api/v1/common/states')
export class StatesCommonV1Controller {
  constructor(@Inject(StatesCommonService) private readonly records: StatesCommonService) {}
