...
@Controller('api/v1/common/brands')
export class BrandsCommonV1Controller {
  constructor(@Inject(BrandsCommonService) private readonly records: BrandsCommonService) {}
