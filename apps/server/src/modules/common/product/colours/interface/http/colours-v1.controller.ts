...
@Controller('api/v1/common/colours')
export class ColoursCommonV1Controller {
  constructor(@Inject(ColoursCommonService) private readonly records: ColoursCommonService) {}
