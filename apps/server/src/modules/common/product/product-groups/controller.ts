...
@Controller('api/v1/common/productGroups')
export class ProductGroupsCommonV1Controller {
  constructor(@Inject(ProductGroupsCommonService) private readonly records: ProductGroupsCommonService) {}
