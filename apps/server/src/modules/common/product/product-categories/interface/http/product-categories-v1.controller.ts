...
@Controller('api/v1/common/productCategories')
export class ProductCategoriesCommonV1Controller {
  constructor(@Inject(ProductCategoriesCommonService) private readonly records: ProductCategoriesCommonService) {}
