...
@Controller('api/v1/common/productTypes')
export class ProductTypesCommonV1Controller {
  constructor(@Inject(ProductTypesCommonService) private readonly records: ProductTypesCommonService) {}
