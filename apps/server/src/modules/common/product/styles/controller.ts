...
@Controller('api/v1/common/styles')
export class StylesCommonV1Controller {
  constructor(@Inject(StylesCommonService) private readonly records: StylesCommonService) {}
