...
@Controller('api/v1/common/orderTypes')
export class OrderTypesCommonV1Controller {
  constructor(@Inject(OrderTypesCommonService) private readonly records: OrderTypesCommonService) {}
