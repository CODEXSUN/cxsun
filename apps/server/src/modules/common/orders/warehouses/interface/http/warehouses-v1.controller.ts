...
@Controller('api/v1/common/warehouses')
export class WarehousesCommonV1Controller {
  constructor(@Inject(WarehousesCommonService) private readonly records: WarehousesCommonService) {}
