...
@Controller('api/v1/common/contactTypes')
export class ContactTypesCommonV1Controller {
  constructor(@Inject(ContactTypesCommonService) private readonly records: ContactTypesCommonService) {}
