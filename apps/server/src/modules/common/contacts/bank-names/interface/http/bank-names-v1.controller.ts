...
@Controller('api/v1/common/bankNames')
export class BankNamesCommonV1Controller {
  constructor(@Inject(BankNamesCommonService) private readonly records: BankNamesCommonService) {}
