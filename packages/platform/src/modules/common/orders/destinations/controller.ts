...
@Controller('api/v1/common/destinations')
export class DestinationsCommonV1Controller {
  constructor(@Inject(DestinationsCommonService) private readonly records: DestinationsCommonService) {}
