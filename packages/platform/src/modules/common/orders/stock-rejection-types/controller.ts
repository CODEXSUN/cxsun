...
@Controller('api/v1/common/stockRejectionTypes')
export class StockRejectionTypesCommonV1Controller {
  constructor(@Inject(StockRejectionTypesCommonService) private readonly records: StockRejectionTypesCommonService) {}
