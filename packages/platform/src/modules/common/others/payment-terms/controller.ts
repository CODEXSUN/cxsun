...
@Controller('api/v1/common/paymentTerms')
export class PaymentTermsCommonV1Controller {
  constructor(@Inject(PaymentTermsCommonService) private readonly records: PaymentTermsCommonService) {}
