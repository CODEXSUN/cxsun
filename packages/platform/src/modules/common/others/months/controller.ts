...
@Controller('api/v1/common/months')
export class MonthsCommonV1Controller {
  constructor(@Inject(MonthsCommonService) private readonly records: MonthsCommonService) {}
