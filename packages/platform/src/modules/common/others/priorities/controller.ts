...
@Controller('api/v1/common/priorities')
export class PrioritiesCommonV1Controller {
  constructor(@Inject(PrioritiesCommonService) private readonly records: PrioritiesCommonService) {}
