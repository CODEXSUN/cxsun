...
@Controller('api/v1/common/hsnCodes')
export class HsnCodesCommonV1Controller {
  constructor(@Inject(HsnCodesCommonService) private readonly records: HsnCodesCommonService) {}
