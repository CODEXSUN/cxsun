...
@Controller('api/v1/common/contactGroups')
export class ContactGroupsCommonV1Controller {
  constructor(@Inject(ContactGroupsCommonService) private readonly records: ContactGroupsCommonService) {}
