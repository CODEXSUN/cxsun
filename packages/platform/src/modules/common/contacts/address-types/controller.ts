...
@Controller('api/v1/common/addressTypes')
export class AddressTypesCommonV1Controller {
  constructor(@Inject(AddressTypesCommonService) private readonly records: AddressTypesCommonService) {}
